...
option_list <- list(
  make_option(c("--model"), default="str2_med", help="Model to use"),
  ...
  make_option(c("--maxiter"), type="integer", default=20, help="Maximum iterations"),
  ...
  make_option(c("--seed_end"), type="integer", default=6, help="Last seed for the GA"),
